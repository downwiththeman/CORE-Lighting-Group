...
LPD6803 strip = LPD6803(40, dataPin, clockPin);
...
void loop() {
  ...
  colorWipe(Color(63, 50, 0), 50);
  colorWipe(Color(63, 63, 0), 50);
  colorWipe(Color(50, 63, 0), 50);
  colorWipe(Color(0, 63, 0), 50);
  colorWipe(Color(0, 63, 63), 50);
  colorWipe(Color(0, 50, 63), 50);
  colorWipe(Color(0, 0, 63), 50);
  colorWipe(Color(50, 0, 63), 50);
  colorWipe(Color(63, 0, 63), 50);
  colorWipe(Color(63, 0, 50), 50);
